...
// Test Protector
const _AM_ADV_SUBTITLECHECK = 'Test Protector Security';
const _AM_ADV_CHECKCONTAMI = 'Prevent injection vulnerabilities';
const _AM_ADV_CHECKISOCOM = 'Prevent isolated comments';
